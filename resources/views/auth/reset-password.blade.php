...
@section('auth-content')
    ...
    <form action="{{ route('login') }}" method="POST">
        ...
        <div class="form-floating mb-20px">
            <input name="password_confirmation" type="password" class="form-control fs-13px h-45px" id="password_confirmation"
                   placeholder="Confirm the password"/>
            <label for="password" class="d-flex align-items-center py-0">Confirm the password</label>
        </div>
